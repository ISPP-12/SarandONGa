...
class ServiceAmountTestCase(TestCase):
    ...
    def test_service_amount_create_correct(self):
        ...
        self.assertEqual(service_amount.date, datetime.datetime(
    ...
    def test_service_amount_update_correct(self):
        ...
        service_amount.date = datetime.datetime(
...
class ServiceTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.asem_user = ASEMUser.objects.create(email="manfergom@gmail.com",
                                                 ...
                                                 birth_date=datetime.datetime(
                                                     1995, 2, 27, tzinfo=datetime.timezone.utc),
                                                 sex="Masculino",
                                                 city="Sevilla",
    ...
    def test_service_create_correct(self):
        ...
        self.assertEqual(service.date, datetime.datetime(
            2018, 2, 1, tzinfo=datetime.timezone.utc))
    ...
    def test_service_update_correct(self):
        ...
        service.date = datetime.datetime(
