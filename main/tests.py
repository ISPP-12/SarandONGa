...
class PricingPlanTestCase(StaticLiveServerTestCase):
    ...
    def test_pricing_plan_exploratory(self):
        ...
        pricing = (
            self.driver.find_element(By.CLASS_NAME, "demo")
            .find_element(By.CLASS_NAME, "demo")
            .find_elements(By.CLASS_NAME, "pricingTable")
        )
        ...
        self.assertEqual(
            container2.find_element(By.TAG_NAME, "button")
