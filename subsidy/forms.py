...
class FilterSubsidyForm(forms.Form):
    ...
    min_presentation_date = forms.DateField(required=False, widget=forms.DateInput(
        attrs={'type': 'date'}), label="Fecha de presentación después del")
    max_presentation_date = forms.DateField(required=False, widget=forms.DateInput(
        attrs={'type': 'date'}), label="Fecha de presentación antes del")
    min_payment_date = forms.DateField(required=False, widget=forms.DateInput(
        attrs={'type': 'date'}), label="Fecha de pago después del")
    max_payment_date = forms.DateField(required=False, widget=forms.DateInput(
        attrs={'type': 'date'}), label="Fecha de pago antes del")
    min_provisional_resolution_date = forms.DateField(required=False, widget=forms.DateInput(
        attrs={'type': 'date'}), label="Fecha de resolución provisional después del")
    max_provisional_resolution_date = forms.DateField(required=False, widget=forms.DateInput(
        attrs={'type': 'date'}), label="Fecha de resolución provisional antes del")
    min_final_resolution_date = forms.DateField(required=False, widget=forms.DateInput(
        attrs={'type': 'date'}), label="Fecha de resolución final después del")
    max_final_resolution_date = forms.DateField(required=False, widget=forms.DateInput(
        attrs={'type': 'date'}), label="Fecha de resolución final antes del")
    organism = forms.CharField(
        max_length=100, required=False, label="Organismo")
