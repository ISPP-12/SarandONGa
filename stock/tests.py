...
class StockTestCase(TestCase):
    def setUp(self):
        ...
        self.stock1 = Stock.objects.create(
            name="Manzanas", quantity=4, amount=3.0, ong=self.ong)
        self.stock2 = Stock.objects.create(
            name="Naranjas", quantity=7, amount=3.0, ong=self.ong)
    ...
    def test_stock_create(self):
        ...
        Stock.objects.create(name="Peras", amount=3.0,
                             quantity=9, ong=self.ong)
    ...
    def test_get_stock(self):
        stock = Stock.objects.create(
            name='Test Stock', amount=3.0, quantity=100.00, ong=self.ong)
    ...
    def test_create_stock_without_amount(self):
        with self.assertRaises(Exception):
            Stock.objects.create(
                name='Test Stock', amount=None, quantity=100.00)
    ...
    def test_create_quantity_max(self):
        with self.assertRaises(Exception):
            s = Stock.objects.create(
                name='Test Stock', amount=3.0, quantity=10000000000000)
            s.full_clean()
    ...
    def test_create_quantity_min(self):
        with self.assertRaises(Exception):
            s = Stock.objects.create(
                name='Test Stock', amount=3.0, quantity=-1)
            s.full_clean()
    ...
    def test_create_quantity_blank(self):
        with self.assertRaises(Exception):
            s = Stock.objects.create(
                name='Test Stock', amount=3.0, quantity='')
            s.full_clean()
    ...
    def test_create_quantity_string(self):
        with self.assertRaises(Exception):
            s = Stock.objects.create(
                name='Test Stock', amount=3.0, quantity='a')
            s.full_clean()
    ...
    def test_create_amount_max(self):
        with self.assertRaises(Exception):
            s = Stock.objects.create(
                name='Test Stock', amount=10000000000000, quantity=100.00)
            s.full_clean()
    ...
    def test_create_amount_min(self):
        with self.assertRaises(Exception):
            s = Stock.objects.create(
                name='Test Stock', amount=-1, quantity=100.00)
            s.full_clean()
    ...
    def test_create_amount_blank(self):
        with self.assertRaises(Exception):
            s = Stock.objects.create(
                name='Test Stock', amount='', quantity=100.00)
            s.full_clean()
    ...
    def test_create_amount_string(self):
        with self.assertRaises(Exception):
            s = Stock.objects.create(
                name='Test Stock', amount='a', quantity=100.00)
            s.full_clean()
...
class StockListViewTestCaseVidessur(StaticLiveServerTestCase):
    def setUp(self):
        ...
        self.test_stock_1 = Stock(
            name="Test stock 1", amount=3.0, ong=self.ong, quantity=150)
    ...
    def test_access_stock_view(self):
        ...
        test_stock_div = self.driver.find_element(
            By.ID, f"id-productDiv-{self.test_stock_1.id}")
        test_stock_text = test_stock_div.find_element(
            By.CSS_SELECTOR, "h5.card-title span").text
    ...
    def test_delete_stock_view(self):
        ...
        test_stock_div.find_element(
            By.ID, f"id-delete-{self.test_stock_1.id}").click()
    ...
    def test_stock_register_view_update(self):
        ...
        # Update item
        test_stock_div.find_element(
            By.ID, f"id-update-{self.test_stock_1.id}").click()
