...
class Stock(models.Model):
    ...
    model = models.CharField(
        max_length=200, verbose_name="Modelo", null=True, blank=True)
    ...
    photo = models.ImageField(
        verbose_name="Foto", upload_to="./static/img/stock/", null=True, blank=True)
    ...
    def save(self, *args, **kwargs):
        ...
        if (self.quantity < 3):
            ...
            send_mail(subject, message, 'sarandonga.contact@gmail.com',
                      ['sarandonga.contact@gmail.com'])
       # self.slug = slugify(self.name + ' ' + str(self.id))
        if self.amount:
            if self.amount < 0:
