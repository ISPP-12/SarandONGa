...
class CreateNewGodFather(forms.ModelForm):
    class Meta:
        model = GodFather
        fields = ['dni','name','surnames','email','birth_date','sex','city','address','telephone','postal_code','is_worker', 'payment_method', 'bank_account_number','bank_account_holder','bank_account_reference','amount','frequency','seniority','notes','status']
        widgets = {
