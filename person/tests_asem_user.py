...
class ASEMUserTestCase(TestCase):
    ...
    def setUp(self):
        ...
        ASEMUser.objects.create(email="tcamerob@gmail.com",
                                ...
                                birth_date=datetime.datetime(
                                    2000, 1, 24, tzinfo=datetime.timezone.utc),
                                sex="Masculino",
                                city="Sevilla",
                                address="Logroño 19",
                                telephone=691644398,
        ...
        self.asem_user_update = ASEMUser.objects.create(email="mariafg@gmail.com",
                                                        ...
                                                        surname="Fernández",
                                                        birth_date=datetime.datetime(
                                                            1999, 3, 1, tzinfo=datetime.timezone.utc),
                                                        sex="Femenino",
                                                        city="Sevilla",
    ...
    def test_asem_user_create(self):
        ...
        self.assertEqual(asemuser.birth_date.strftime(
            '%Y-%m-%d'), "2000-01-24")
    ...
    def test_asem_user_update(self):
        ...
        asemuser.birth_date = datetime.datetime(
            2001, 1, 24, tzinfo=datetime.timezone.utc)
        ...
        self.assertEqual(asemuser.bank_account_number,
                         "ES6700832134418939683447")
    ...
    def test_asem_user_update_bank_account_number_incorrect_number(self):
        with self.assertRaises(Exception):
            self.asem_user_update.bank_account_number = "ES121212121212121212"
            self.asem_user_update.full_clean()
