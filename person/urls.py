...
urlpatterns = [
    ...
    path('child/<int:child_id>', views.child_details, name="child_details"), # TODO
    ...
    path('asem/<int:asem_user_id>', views.asem_user_details, name='asem_user_details'), #TODO
    ...
    path('worker/<int:worker_id>', views.worker_details, name="worker_details"), #TODO
    ...
    path('godfather/<int:godfather_id>',views.godfather_details, name="godfather_details"), #TODO
    ...
    path('volunteer/<int:volunteer_id>', views.volunteer_details, name='volunteer_details') #TODO
]
