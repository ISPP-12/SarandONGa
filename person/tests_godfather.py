...
class GodFatherTestCase(TestCase):
    ...
    def test_godfather_create(self):
        ...
        self.assertEqual(gf.termination_date.strftime(
            '%Y-%m-%d'), "2024-01-24")
    ...
    def test_godfather_update(self):
        ...
        self.assertEqual(godfather.bank_account_number,
                         'ES6621000418401234567890')
        self.assertEqual(godfather.bank_account_holder, 'John Doe 2')
        self.assertEqual(godfather.bank_account_reference,
                         '1465 0100 72 2030876299')
        self.assertEqual(godfather.frequency, 'Y')
        self.assertEqual(godfather.start_date.strftime(
            '%Y-%m-%d'), "2000-01-24")
        self.assertEqual(godfather.termination_date.strftime(
            '%Y-%m-%d'), "2010-01-24")
